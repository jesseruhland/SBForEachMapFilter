...
function removeVowels(str) {
    let letterArr = [...str.toLowerCase()]
    let vowelRegEx = /[aeiou]/
    function isNotVowel(val) {
        return !vowelRegEx.test(`${val}`)
    }
    let filteredArr = letterArr.filter(isNotVowel)
